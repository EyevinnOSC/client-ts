...
const ENCORE_OPENAPI_URL =
  'https://raw.githubusercontent.com/svt/encore-doc/main/src/docs/openapi/openapi.json';

async function generateEncoreInstanceTypes() {
  spawnSync(
    'npx',
    [
      'openapi-typescript',
      ENCORE_OPENAPI_URL,
      '-o',
      'src/generated/encore-instance.ts'
    ],
    { stdio: 'inherit' }
  );
...
`;
  appendFileSync('src/generated/encore-instance.ts', aliases);

  const indexTs = `export type {
  EncoreJobRequest,
  EncoreJobResponse,
  EncoreJobInput,
  EncoreJobOutput,
...
async function main() {
  ...
  */
  ...
  await generateEncoreInstanceTypes();
  const tests = `/**
  * This file was auto-generated by openapi-typescript.
  * Do not make direct changes to the file.
  */
